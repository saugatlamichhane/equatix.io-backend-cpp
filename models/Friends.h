...
public:
  struct Cols {
    ...
    static const std::string _friend_uid;
  };
   ...
   */
  explicit Friends(const drogon::orm::Row &r,
   ...
   */
  Friends(const Json::Value &pJson,
  ...
  /**  For column friend_uid  */
  /// Get the value of the column friend_uid, returns the default value if the
  /// column is null
  const std::string &getValueOfFriendUid() const noexcept;
  /// Return a shared_ptr object pointing to the column const value, or an empty
  /// shared_ptr object if the column is null
  const std::shared_ptr<std::string> &getFriendUid() const noexcept;
  /// Set the value of the column friend_uid
  void setFriendUid(const std::string &pFriendUid) noexcept;
  void setFriendUid(std::string &&pFriendUid) noexcept;
...
private:
  ...
  friend drogon::orm::BaseBuilder<Friends, true, true>;
  friend drogon::orm::BaseBuilder<Friends, true, false>;
  friend drogon::orm::BaseBuilder<Friends, false, true>;
  friend drogon::orm::BaseBuilder<Friends, false, false>;
#ifdef __cpp_impl_coroutine
  ...
  std::shared_ptr<std::string> friendUid_;
  struct MetaData {
