...
public:
   ...
   */
  explicit Challenges(const drogon::orm::Row &r,
  ...
  /// Get the value of the column challenger_id, returns the default value if
  /// the column is null
  ...
  /// Get the value of the column opponent_id, returns the default value if the
  /// column is null
