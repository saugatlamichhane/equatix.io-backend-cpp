...
const std::vector<typename Challenges::MetaData> Challenges::metaData_ = {
    ...
    {"created_at", "::trantor::Date", "timestamp without time zone", 0, 0, 0,
     0},
    {"updated_at", "::trantor::Date", "timestamp without time zone", 0, 0, 0,
     0}};
...
Challenges::Challenges(const Row &r, const ssize_t indexOffset) noexcept {
  if (indexOffset < 0) {
    ...
    if (!r["challenger_id"].isNull()) {
      challengerId_ =
          std::make_shared<std::string>(r["challenger_id"].as<std::string>());
    }
    if (!r["opponent_id"].isNull()) {
      opponentId_ =
          std::make_shared<std::string>(r["opponent_id"].as<std::string>());
    }
    if (!r["status"].isNull()) {
...
Challenges::Challenges(
  ...
  if (!pMasqueradingVector[1].empty() &&
    ...
    if (!pJson[pMasqueradingVector[1]].isNull()) {
      challengerId_ = std::make_shared<std::string>(
  ...
  if (!pMasqueradingVector[2].empty() &&
    ...
    if (!pJson[pMasqueradingVector[2]].isNull()) {
      opponentId_ = std::make_shared<std::string>(
...
Challenges::Challenges(const Json::Value &pJson) noexcept(false) {
  ...
  if (pJson.isMember("challenger_id")) {
    ...
    if (!pJson["challenger_id"].isNull()) {
      challengerId_ =
          std::make_shared<std::string>(pJson["challenger_id"].asString());
    }
  }
  if (pJson.isMember("opponent_id")) {
    ...
    if (!pJson["opponent_id"].isNull()) {
      opponentId_ =
          std::make_shared<std::string>(pJson["opponent_id"].asString());
    }
  }
...
void Challenges::updateByMasqueradedJson(
    const Json::Value &pJson,
    const std::vector<std::string> &pMasqueradingVector) noexcept(false) {
  if (pMasqueradingVector.size() != 6) {
    LOG_ERROR << "Bad masquerading vector";
...
Challenges::getChallengerId() const noexcept {
  return challengerId_;
}
...
Challenges::getCreatedAt() const noexcept {
  return createdAt_;
}
...
const std::shared_ptr<::trantor::Date> &
Challenges::getUpdatedAt() const noexcept {
  return updatedAt_;
}
...
const std::vector<std::string> &Challenges::insertColumns() noexcept {
  static const std::vector<std::string> inCols = {
      "challenger_id", "opponent_id", "status", "created_at", "updated_at"};
  return inCols;
}
...
std::string Challenges::toString() const { return toJson().toStyledString(); }
...
bool Challenges::validateJsonForCreation(const Json::Value &pJson,
                                         std::string &err) {
  if (pJson.isMember("id")) {
  ...
  if (pJson.isMember("challenger_id")) {
    if (!validJsonOfField(1, "challenger_id", pJson["challenger_id"], err,
                          true))
      return false;
  } else {
...
bool Challenges::validateMasqueradedJsonForCreation(
    const Json::Value &pJson,
...
bool Challenges::validateJsonForUpdate(const Json::Value &pJson,
                                       std::string &err) {
  if (pJson.isMember("id")) {
...
bool Challenges::validateMasqueradedJsonForUpdate(
    const Json::Value &pJson,
    const std::vector<std::string> &pMasqueradingVector, std::string &err) {
  if (pMasqueradingVector.size() != 6) {
    err = "Bad masquerading vector";
...
bool Challenges::validJsonOfField(size_t index, const std::string &fieldName,
