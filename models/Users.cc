...
Users::Users(
  ...
  if (!pMasqueradingVector[3].empty() &&
    ...
    if (!pJson[pMasqueradingVector[3]].isNull()) {
      photo_ = std::make_shared<std::string>(
  ...
  if (!pMasqueradingVector[5].empty() &&
    ...
    if (!pJson[pMasqueradingVector[5]].isNull()) {
      gamesplayed_ = std::make_shared<int32_t>(
  ...
  if (!pMasqueradingVector[7].empty() &&
    ...
    if (!pJson[pMasqueradingVector[7]].isNull()) {
      losses_ = std::make_shared<int32_t>(
  ...
  if (!pMasqueradingVector[8].empty() &&
    ...
    if (!pJson[pMasqueradingVector[8]].isNull()) {
      draws_ = std::make_shared<int32_t>(
...
Users::Users(const Json::Value &pJson) noexcept(false) {
  ...
  if (pJson.isMember("gamesplayed")) {
    ...
    if (!pJson["gamesplayed"].isNull()) {
      gamesplayed_ =
          std::make_shared<int32_t>((int32_t)pJson["gamesplayed"].asInt64());
    }
  }
...
const std::shared_ptr<int32_t> &Users::getElo() const noexcept { return elo_; }
