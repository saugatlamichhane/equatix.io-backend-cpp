...
Friends::Friends(const Row &r, const ssize_t indexOffset) noexcept {
  if (indexOffset < 0) {
    ...
    if (!r["friend_uid"].isNull()) {
      friendUid_ =
          std::make_shared<std::string>(r["friend_uid"].as<std::string>());
    }
  } else {
...
Friends::Friends(
  ...
  if (!pMasqueradingVector[1].empty() &&
    ...
    if (!pJson[pMasqueradingVector[1]].isNull()) {
      uid_ = std::make_shared<std::string>(
  ...
  if (!pMasqueradingVector[2].empty() &&
    ...
    if (!pJson[pMasqueradingVector[2]].isNull()) {
      friendUid_ = std::make_shared<std::string>(
...
Friends::Friends(const Json::Value &pJson) noexcept(false) {
  ...
  if (pJson.isMember("friend_uid")) {
    ...
    if (!pJson["friend_uid"].isNull()) {
      friendUid_ =
          std::make_shared<std::string>(pJson["friend_uid"].asString());
    }
  }
}

void Friends::updateByMasqueradedJson(
    const Json::Value &pJson,
    const std::vector<std::string> &pMasqueradingVector) noexcept(false) {
  if (pMasqueradingVector.size() != 3) {
    LOG_ERROR << "Bad masquerading vector";
...
const std::shared_ptr<int32_t> &Friends::getId() const noexcept { return id_; }
...
const std::vector<std::string> &Friends::insertColumns() noexcept {
  static const std::vector<std::string> inCols = {"uid", "friend_uid"};
  return inCols;
}
...
std::string Friends::toString() const { return toJson().toStyledString(); }
...
bool Friends::validateJsonForCreation(const Json::Value &pJson,
                                      std::string &err) {
  if (pJson.isMember("id")) {
...
bool Friends::validateMasqueradedJsonForCreation(
    const Json::Value &pJson,
...
bool Friends::validateJsonForUpdate(const Json::Value &pJson,
                                    std::string &err) {
  if (pJson.isMember("id")) {
...
bool Friends::validateMasqueradedJsonForUpdate(
    const Json::Value &pJson,
    const std::vector<std::string> &pMasqueradingVector, std::string &err) {
  if (pMasqueradingVector.size() != 3) {
    err = "Bad masquerading vector";
...
bool Friends::validJsonOfField(size_t index, const std::string &fieldName,
