...
public:
    METHOD_LIST_BEGIN
    ADD_METHOD_TO(ChallengeController::sendChallenge, "/challenge/send/{opponentId}", Post, "FirebaseAuthFilter");
    ADD_METHOD_TO(ChallengeController::acceptChallenge, "/challenge/accept/{challengeId}", Put, "FirebaseAuthFilter");
    ...
    void acceptChallenge(const HttpRequestPtr &req, std::function<void(const HttpResponsePtr &)> &&callback, const std::string &challengeId);
