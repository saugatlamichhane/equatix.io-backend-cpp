...
void Feedback::sendFeedback(const drogon::HttpRequestPtr& req, std::function<void(const drogon::HttpResponsePtr&)>&& callback){
    ...
    mp.insert(newFeedback,[callback](Feedbacks feedback) {
                Json::Value result;
